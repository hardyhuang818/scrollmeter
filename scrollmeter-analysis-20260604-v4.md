...
| ⑤ | DisplayLink → HP PG27 | 触控板 Trackpad | Safari | — | 56.9 | **2.56** ms/s ✅ | 0.63 | 8.08 ms | ⚠️ FPS 偏低 |
| ⑥ | DisplayLink → HP PG27 | 触控板 Trackpad | Chrome | ON  | 53.9 | **10.09** ms/s | 0.84 | 9.15 ms | ❌ 卡顿 |
| ⑦ | DisplayLink → HP PG27 | 触控板 Trackpad | Chrome | OFF | 59.0 | **12.47** ms/s | 0.74 | **8.61** ms 🆕 | ❌ 卡顿 |
